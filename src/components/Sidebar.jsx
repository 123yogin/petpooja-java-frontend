    ...
    <div className="w-64 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 flex flex-col z-30">
      ...
      <div className="p-6 border-b border-gray-200 flex-shrink-0">
        <div className="flex items-center space-x-3 mb-2">
          ...
          <h1 className="text-xl font-semibold text-black">RestroSuite</h1>
        </div>
        <p className="text-xs text-gray-600 mt-0.5">Restaurant POS</p>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 flex-shrink-0 bg-white">
        <div className="flex items-center space-x-3 px-3 py-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-black truncate">{user?.role || "User"}</p>
